...
@CapabilityDescription("Retrieves a file from HDFS along with checksum as an attribute. The content of the incoming FlowFile is replaced by the content of the file in HDFS. "
...
public class FetchHDFSCRC32C extends AbstractHadoopProcessor {
